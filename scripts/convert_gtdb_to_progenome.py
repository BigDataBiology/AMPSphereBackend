...
# from GTDB
data = pd.read_table('bac120_metadata_r202.tsv',
                     sep='\t',
                     header='infer',
                     low_memory=False)
...
# from GTDB
data2 = pd.read_table('ar122_metadata_r202.tsv',
                      sep='\t',
                      header='infer',
                      low_memory=False)
...
refdata = pd.read_table('progenomes_samples.tsv',
                        sep='\t',
                        header=None,
...
print('... export 1')
dfd.to_csv('gtdb_to_pgenomes.tsv',
           sep='\t',
           header=True,
           index=None)
...
print('... export 2')
df.to_csv('conv_pgen_to_gtdb_list.tsv',
          sep='\t',
          header='infer',
          index=None)
